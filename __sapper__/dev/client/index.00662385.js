import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.dda87423.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "overlay svelte-159qjfe");
			add_location(div0, file, 89, 6, 1228);
			if (source.src !== (source_src_value = "coding-video.mp4")) attr_dev(source, "src", source_src_value);
			attr_dev(source, "type", "video/mp4");
			add_location(source, file, 92, 8, 1352);
			video.playsInline = "playsinline";
			video.autoplay = "autoplay";
			video.muted = "muted";
			video.loop = "loop";
			attr_dev(video, "class", "svelte-159qjfe");
			add_location(video, file, 91, 6, 1263);
			attr_dev(h10, "class", "display-3 az svelte-159qjfe");
			add_location(h10, file, 98, 12, 1575);
			attr_dev(h11, "class", "display-6 az svelte-159qjfe");
			add_location(h11, file, 99, 12, 1631);
			attr_dev(p, "class", "py-5 about-me svelte-159qjfe");
			add_location(p, file, 100, 12, 1692);
			add_location(footer, file, 106, 14, 2166);
			attr_dev(i0, "class", "fab fa-linkedin-in fa-2x mr-2");
			add_location(i0, file, 109, 103, 2369);
			attr_dev(a0, "href", "https://www.linkedin.com/in/azdunek/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "rel", "noopener noreferrer");
			add_location(a0, file, 109, 14, 2280);
			attr_dev(i1, "class", "fab fa-github index-fa-github fa-2x ml-3 svelte-159qjfe");
			add_location(i1, file, 110, 94, 2513);
			attr_dev(a1, "href", "https://github.com/ajzdunek");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "rel", "noopener noreferrer");
			add_location(a1, file, 110, 14, 2433);
			attr_dev(i2, "class", "fab fa-stack-overflow fa-2x ml-3");
			add_location(i2, file, 111, 114, 2688);
			attr_dev(a2, "href", "https://stackoverflow.com/users/9090178/azdunek");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "rel", "noopener noreferrer");
			add_location(a2, file, 111, 14, 2588);
			attr_dev(div1, "class", "container py-3 text-center svelte-159qjfe");
			add_location(div1, file, 108, 14, 2225);
			attr_dev(div2, "class", "az-sd svelte-159qjfe");
			add_location(div2, file, 105, 12, 2132);
			attr_dev(div3, "class", "w-100 text-white");
			add_location(div3, file, 97, 10, 1532);
			attr_dev(div4, "class", "d-flex h-100 text-center align-items-center");
			add_location(div4, file, 96, 8, 1464);
			attr_dev(div5, "class", "container h-100 svelte-159qjfe");
			add_location(div5, file, 95, 6, 1426);
			attr_dev(header, "class", "svelte-159qjfe");
			add_location(header, file, 88, 4, 1213);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
