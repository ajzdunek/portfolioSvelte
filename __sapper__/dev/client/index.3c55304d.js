import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.f115abf4.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "overlay svelte-kko41s");
			add_location(div0, file, 111, 6, 1572);
			if (source.src !== (source_src_value = "coding-video.mp4")) attr_dev(source, "src", source_src_value);
			attr_dev(source, "type", "video/mp4");
			add_location(source, file, 114, 8, 1696);
			video.playsInline = "playsinline";
			video.autoplay = "autoplay";
			video.muted = "muted";
			video.loop = "loop";
			attr_dev(video, "class", "svelte-kko41s");
			add_location(video, file, 113, 6, 1607);
			attr_dev(h10, "class", "display-3 me svelte-kko41s");
			add_location(h10, file, 121, 12, 1957);
			attr_dev(h11, "class", "display-6 occupation svelte-kko41s");
			add_location(h11, file, 122, 12, 2013);
			attr_dev(p, "class", "py-5 about-me svelte-kko41s");
			add_location(p, file, 123, 12, 2082);
			attr_dev(div1, "class", "whoami-mobile svelte-kko41s");
			add_location(div1, file, 120, 10, 1917);
			add_location(footer, file, 129, 14, 2574);
			attr_dev(i0, "class", "fab fa-linkedin-in fa-2x mr-2");
			add_location(i0, file, 132, 103, 2777);
			attr_dev(a0, "href", "https://www.linkedin.com/in/azdunek/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "rel", "noopener noreferrer");
			add_location(a0, file, 132, 14, 2688);
			attr_dev(i1, "class", "fab fa-github index-fa-github fa-2x ml-3 svelte-kko41s");
			add_location(i1, file, 133, 94, 2921);
			attr_dev(a1, "href", "https://github.com/ajzdunek");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "rel", "noopener noreferrer");
			add_location(a1, file, 133, 14, 2841);
			attr_dev(i2, "class", "fab fa-stack-overflow fa-2x ml-3");
			add_location(i2, file, 134, 114, 3096);
			attr_dev(a2, "href", "https://stackoverflow.com/users/9090178/azdunek");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "rel", "noopener noreferrer");
			add_location(a2, file, 134, 14, 2996);
			attr_dev(div2, "class", "container py-3 text-center svelte-kko41s");
			add_location(div2, file, 131, 14, 2633);
			attr_dev(div3, "class", "az-sd svelte-kko41s");
			add_location(div3, file, 128, 12, 2540);
			attr_dev(div4, "class", "w-100 text-white");
			add_location(div4, file, 119, 10, 1876);
			attr_dev(div5, "class", "d-flex h-100 text-center align-items-center");
			add_location(div5, file, 118, 8, 1808);
			attr_dev(div6, "class", "container h-100 svelte-kko41s");
			add_location(div6, file, 117, 6, 1770);
			attr_dev(header, "class", "svelte-kko41s");
			add_location(header, file, 110, 4, 1557);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
