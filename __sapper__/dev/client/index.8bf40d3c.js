import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.a005a078.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "overlay svelte-1gmcdt5");
			add_location(div0, file, 95, 6, 1266);
			if (source.src !== (source_src_value = "coding-video.mp4")) attr_dev(source, "src", source_src_value);
			attr_dev(source, "type", "video/mp4");
			add_location(source, file, 98, 8, 1390);
			video.playsInline = "playsinline";
			video.autoplay = "autoplay";
			video.muted = "muted";
			video.loop = "loop";
			attr_dev(video, "class", "svelte-1gmcdt5");
			add_location(video, file, 97, 6, 1301);
			attr_dev(h10, "class", "display-3 az svelte-1gmcdt5");
			add_location(h10, file, 105, 12, 1651);
			attr_dev(h11, "class", "display-6 az svelte-1gmcdt5");
			add_location(h11, file, 106, 12, 1707);
			attr_dev(p, "class", "py-5 about-me svelte-1gmcdt5");
			add_location(p, file, 107, 12, 1768);
			attr_dev(div1, "class", "whoami-mobile svelte-1gmcdt5");
			add_location(div1, file, 104, 10, 1611);
			add_location(footer, file, 113, 14, 2260);
			attr_dev(i0, "class", "fab fa-linkedin-in fa-2x mr-2");
			add_location(i0, file, 116, 103, 2463);
			attr_dev(a0, "href", "https://www.linkedin.com/in/azdunek/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "rel", "noopener noreferrer");
			add_location(a0, file, 116, 14, 2374);
			attr_dev(i1, "class", "fab fa-github index-fa-github fa-2x ml-3 svelte-1gmcdt5");
			add_location(i1, file, 117, 94, 2607);
			attr_dev(a1, "href", "https://github.com/ajzdunek");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "rel", "noopener noreferrer");
			add_location(a1, file, 117, 14, 2527);
			attr_dev(i2, "class", "fab fa-stack-overflow fa-2x ml-3");
			add_location(i2, file, 118, 114, 2782);
			attr_dev(a2, "href", "https://stackoverflow.com/users/9090178/azdunek");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "rel", "noopener noreferrer");
			add_location(a2, file, 118, 14, 2682);
			attr_dev(div2, "class", "container py-3 text-center svelte-1gmcdt5");
			add_location(div2, file, 115, 14, 2319);
			attr_dev(div3, "class", "az-sd svelte-1gmcdt5");
			add_location(div3, file, 112, 12, 2226);
			attr_dev(div4, "class", "w-100 text-white");
			add_location(div4, file, 103, 10, 1570);
			attr_dev(div5, "class", "d-flex h-100 text-center align-items-center");
			add_location(div5, file, 102, 8, 1502);
			attr_dev(div6, "class", "container h-100 svelte-1gmcdt5");
			add_location(div6, file, 101, 6, 1464);
			attr_dev(header, "class", "svelte-1gmcdt5");
			add_location(header, file, 94, 4, 1251);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
