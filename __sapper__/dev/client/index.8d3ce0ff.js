import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.ddd56e6b.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "overlay svelte-nypqr5");
			add_location(div0, file, 104, 6, 1407);
			if (source.src !== (source_src_value = "coding-video.mp4")) attr_dev(source, "src", source_src_value);
			attr_dev(source, "type", "video/mp4");
			add_location(source, file, 107, 8, 1531);
			video.playsInline = "playsinline";
			video.autoplay = "autoplay";
			video.muted = "muted";
			video.loop = "loop";
			attr_dev(video, "class", "svelte-nypqr5");
			add_location(video, file, 106, 6, 1442);
			attr_dev(h10, "class", "display-3 az svelte-nypqr5");
			add_location(h10, file, 114, 12, 1792);
			attr_dev(h11, "class", "display-6 az svelte-nypqr5");
			add_location(h11, file, 115, 12, 1848);
			attr_dev(p, "class", "py-5 about-me svelte-nypqr5");
			add_location(p, file, 116, 12, 1909);
			attr_dev(div1, "class", "whoami-mobile svelte-nypqr5");
			add_location(div1, file, 113, 10, 1752);
			add_location(footer, file, 122, 14, 2401);
			attr_dev(i0, "class", "fab fa-linkedin-in fa-2x mr-2");
			add_location(i0, file, 125, 103, 2604);
			attr_dev(a0, "href", "https://www.linkedin.com/in/azdunek/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "rel", "noopener noreferrer");
			add_location(a0, file, 125, 14, 2515);
			attr_dev(i1, "class", "fab fa-github index-fa-github fa-2x ml-3 svelte-nypqr5");
			add_location(i1, file, 126, 94, 2748);
			attr_dev(a1, "href", "https://github.com/ajzdunek");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "rel", "noopener noreferrer");
			add_location(a1, file, 126, 14, 2668);
			attr_dev(i2, "class", "fab fa-stack-overflow fa-2x ml-3");
			add_location(i2, file, 127, 114, 2923);
			attr_dev(a2, "href", "https://stackoverflow.com/users/9090178/azdunek");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "rel", "noopener noreferrer");
			add_location(a2, file, 127, 14, 2823);
			attr_dev(div2, "class", "container py-3 text-center svelte-nypqr5");
			add_location(div2, file, 124, 14, 2460);
			attr_dev(div3, "class", "az-sd svelte-nypqr5");
			add_location(div3, file, 121, 12, 2367);
			attr_dev(div4, "class", "w-100 text-white");
			add_location(div4, file, 112, 10, 1711);
			attr_dev(div5, "class", "d-flex h-100 text-center align-items-center");
			add_location(div5, file, 111, 8, 1643);
			attr_dev(div6, "class", "container h-100 svelte-nypqr5");
			add_location(div6, file, 110, 6, 1605);
			attr_dev(header, "class", "svelte-nypqr5");
			add_location(header, file, 103, 4, 1392);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
