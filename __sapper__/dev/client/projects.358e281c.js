...
function create_default_slot_22(ctx) {
	...
	const block = {
		c: function create() {
			t = text("Band Website Two (Elemnetag)");
		},
		l: function claim(nodes) {
			t = claim_text(nodes, "Band Website Two (Elemnetag)");
		},
		m: function mount(target, anchor) {
			insert_dev(target, t, anchor);
		},
