import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.b768051c.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "overlay svelte-lgv24a");
			add_location(div0, file, 100, 6, 1380);
			if (source.src !== (source_src_value = "coding-video.mp4")) attr_dev(source, "src", source_src_value);
			attr_dev(source, "type", "video/mp4");
			add_location(source, file, 103, 8, 1504);
			video.playsInline = "playsinline";
			video.autoplay = "autoplay";
			video.muted = "muted";
			video.loop = "loop";
			attr_dev(video, "class", "svelte-lgv24a");
			add_location(video, file, 102, 6, 1415);
			attr_dev(h10, "class", "display-3 me svelte-lgv24a");
			add_location(h10, file, 110, 12, 1765);
			attr_dev(h11, "class", "display-6 occupation svelte-lgv24a");
			add_location(h11, file, 111, 12, 1821);
			attr_dev(p, "class", "py-5 about-me svelte-lgv24a");
			add_location(p, file, 112, 12, 1890);
			attr_dev(div1, "class", "whoami-mobile svelte-lgv24a");
			add_location(div1, file, 109, 10, 1725);
			add_location(footer, file, 118, 14, 2382);
			attr_dev(i0, "class", "fab fa-linkedin-in fa-2x mr-2");
			add_location(i0, file, 121, 103, 2585);
			attr_dev(a0, "href", "https://www.linkedin.com/in/azdunek/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "rel", "noopener noreferrer");
			add_location(a0, file, 121, 14, 2496);
			attr_dev(i1, "class", "fab fa-github index-fa-github fa-2x ml-3 svelte-lgv24a");
			add_location(i1, file, 122, 94, 2729);
			attr_dev(a1, "href", "https://github.com/ajzdunek");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "rel", "noopener noreferrer");
			add_location(a1, file, 122, 14, 2649);
			attr_dev(i2, "class", "fab fa-stack-overflow fa-2x ml-3");
			add_location(i2, file, 123, 114, 2904);
			attr_dev(a2, "href", "https://stackoverflow.com/users/9090178/azdunek");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "rel", "noopener noreferrer");
			add_location(a2, file, 123, 14, 2804);
			attr_dev(div2, "class", "container py-3 text-center svelte-lgv24a");
			add_location(div2, file, 120, 14, 2441);
			attr_dev(div3, "class", "az-sd svelte-lgv24a");
			add_location(div3, file, 117, 12, 2348);
			attr_dev(div4, "class", "w-100 text-white");
			add_location(div4, file, 108, 10, 1684);
			attr_dev(div5, "class", "d-flex h-100 text-center align-items-center");
			add_location(div5, file, 107, 8, 1616);
			attr_dev(div6, "class", "container h-100 svelte-lgv24a");
			add_location(div6, file, 106, 6, 1578);
			attr_dev(header, "class", "svelte-lgv24a");
			add_location(header, file, 99, 4, 1365);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
