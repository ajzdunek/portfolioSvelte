...
function create_default_slot_11(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(option0, file$2, 91, 6, 2169);
			option1.__value = "2";
			option1.value = option1.__value;
			add_location(option1, file$2, 92, 6, 2194);
			option2.__value = "3";
			option2.value = option2.__value;
			add_location(option2, file$2, 93, 6, 2219);
			option3.__value = "4";
			option3.value = option3.__value;
			add_location(option3, file$2, 94, 6, 2244);
			option4.__value = "5";
			option4.value = option4.__value;
			add_location(option4, file$2, 95, 6, 2269);
		},
		m: function mount(target, anchor) {
