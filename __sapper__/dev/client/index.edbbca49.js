import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.c63bf0f1.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "overlay svelte-zic0fm");
			add_location(div0, file, 102, 6, 1482);
			if (source.src !== (source_src_value = "coding-video.mp4")) attr_dev(source, "src", source_src_value);
			attr_dev(source, "type", "video/mp4");
			add_location(source, file, 105, 8, 1606);
			video.playsInline = "playsinline";
			video.autoplay = "autoplay";
			video.muted = "muted";
			video.loop = "loop";
			attr_dev(video, "class", "svelte-zic0fm");
			add_location(video, file, 104, 6, 1517);
			attr_dev(h10, "class", "display-3 me svelte-zic0fm");
			add_location(h10, file, 112, 12, 1867);
			attr_dev(h11, "class", "display-6 occupation svelte-zic0fm");
			add_location(h11, file, 113, 12, 1923);
			attr_dev(p, "class", "py-5 about-me svelte-zic0fm");
			add_location(p, file, 114, 12, 1992);
			attr_dev(div1, "class", "whoami-mobile");
			add_location(div1, file, 111, 10, 1827);
			add_location(footer, file, 120, 14, 2484);
			attr_dev(i0, "class", "fab fa-linkedin-in fa-2x mr-2");
			add_location(i0, file, 123, 103, 2687);
			attr_dev(a0, "href", "https://www.linkedin.com/in/azdunek/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "rel", "noopener noreferrer");
			add_location(a0, file, 123, 14, 2598);
			attr_dev(i1, "class", "fab fa-github index-fa-github fa-2x ml-3 svelte-zic0fm");
			add_location(i1, file, 124, 94, 2831);
			attr_dev(a1, "href", "https://github.com/ajzdunek");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "rel", "noopener noreferrer");
			add_location(a1, file, 124, 14, 2751);
			attr_dev(i2, "class", "fab fa-stack-overflow fa-2x ml-3");
			add_location(i2, file, 125, 114, 3006);
			attr_dev(a2, "href", "https://stackoverflow.com/users/9090178/azdunek");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "rel", "noopener noreferrer");
			add_location(a2, file, 125, 14, 2906);
			attr_dev(div2, "class", "container py-3 text-center svelte-zic0fm");
			add_location(div2, file, 122, 14, 2543);
			attr_dev(div3, "class", "az-sd svelte-zic0fm");
			add_location(div3, file, 119, 12, 2450);
			attr_dev(div4, "class", "w-100 text-white");
			add_location(div4, file, 110, 10, 1786);
			attr_dev(div5, "class", "d-flex h-100 text-center align-items-center");
			add_location(div5, file, 109, 8, 1718);
			attr_dev(div6, "class", "container h-100 svelte-zic0fm");
			add_location(div6, file, 108, 6, 1680);
			attr_dev(header, "class", "svelte-zic0fm");
			add_location(header, file, 101, 4, 1467);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
