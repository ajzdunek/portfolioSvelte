...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			document.title = "Blog";
			attr_dev(h1, "class", "svelte-150l0mh");
			add_location(h1, file, 42, 0, 511);
			attr_dev(ul, "class", "svelte-150l0mh");
