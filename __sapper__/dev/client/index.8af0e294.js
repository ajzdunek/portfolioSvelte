...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 46, 6, 717);
			add_location(li, file, 46, 2, 713);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			document.title = "Blog";
			attr_dev(h1, "class", "svelte-1i7vjym");
			add_location(h1, file, 38, 0, 448);
			attr_dev(ul, "class", "svelte-1i7vjym");
			add_location(ul, file, 40, 0, 467);
			attr_dev(div, "class", "container");
			add_location(div, file, 36, 0, 423);
		},
		m: function mount(target, anchor) {
