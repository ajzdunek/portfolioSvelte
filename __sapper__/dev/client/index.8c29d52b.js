import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.03130092.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "overlay svelte-gme49a");
			add_location(div0, file, 82, 6, 1137);
			if (source.src !== (source_src_value = "coding-video.mp4")) attr_dev(source, "src", source_src_value);
			attr_dev(source, "type", "video/mp4");
			add_location(source, file, 85, 8, 1261);
			video.playsInline = "playsinline";
			video.autoplay = "autoplay";
			video.muted = "muted";
			video.loop = "loop";
			attr_dev(video, "class", "svelte-gme49a");
			add_location(video, file, 84, 6, 1172);
			attr_dev(h10, "class", "display-3 az svelte-gme49a");
			add_location(h10, file, 91, 12, 1484);
			attr_dev(h11, "class", "display-6 az svelte-gme49a");
			add_location(h11, file, 92, 12, 1540);
			attr_dev(p, "class", "py-5 about-me svelte-gme49a");
			add_location(p, file, 93, 12, 1601);
			add_location(footer, file, 99, 14, 2075);
			attr_dev(i0, "class", "fab fa-linkedin-in fa-2x mr-2");
			add_location(i0, file, 102, 103, 2278);
			attr_dev(a0, "href", "https://www.linkedin.com/in/azdunek/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "rel", "noopener noreferrer");
			add_location(a0, file, 102, 14, 2189);
			attr_dev(i1, "class", "fab fa-github index-fa-github fa-2x ml-3 svelte-gme49a");
			add_location(i1, file, 103, 94, 2422);
			attr_dev(a1, "href", "https://github.com/ajzdunek");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "rel", "noopener noreferrer");
			add_location(a1, file, 103, 14, 2342);
			attr_dev(i2, "class", "fab fa-stack-overflow fa-2x ml-3");
			add_location(i2, file, 104, 114, 2597);
			attr_dev(a2, "href", "https://stackoverflow.com/users/9090178/azdunek");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "rel", "noopener noreferrer");
			add_location(a2, file, 104, 14, 2497);
			attr_dev(div1, "class", "container py-3 text-center svelte-gme49a");
			add_location(div1, file, 101, 14, 2134);
			attr_dev(div2, "class", "az-sd svelte-gme49a");
			add_location(div2, file, 98, 12, 2041);
			attr_dev(div3, "class", "w-100 text-white");
			add_location(div3, file, 90, 10, 1441);
			attr_dev(div4, "class", "d-flex h-100 text-center align-items-center");
			add_location(div4, file, 89, 8, 1373);
			attr_dev(div5, "class", "container h-100 svelte-gme49a");
			add_location(div5, file, 88, 6, 1335);
			attr_dev(header, "class", "svelte-gme49a");
			add_location(header, file, 81, 4, 1122);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
