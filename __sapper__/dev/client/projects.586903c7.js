...
function create_default_slot_9(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = space();
			p0 = element("p");
			t1 = text("A fully functional independent music blog built with Jekyll, a blog-aware, static site generator written in Ruby. One of the features I'm proud of in this project was the ability to add search functionality - the search data is stored in a JSON file.");
			t2 = space();
			p1 = element("p");
		...
		l: function claim(nodes) {
			...
			p0 = claim_element(nodes, "P", {});
			var p0_nodes = children(p0);
			t1 = claim_text(p0_nodes, "A fully functional independent music blog built with Jekyll, a blog-aware, static site generator written in Ruby. One of the features I'm proud of in this project was the ability to add search functionality - the search data is stored in a JSON file.");
			p0_nodes.forEach(detach_dev);
			t2 = claim_space(nodes);
			p1 = claim_element(nodes, "P", {});
			var p1_nodes = children(p1);
		...
		h: function hydrate() {
			...
			add_location(strong0, file$1, 142, 7, 3632);
			add_location(p1, file$1, 142, 4, 3629);
			add_location(strong1, file$1, 142, 98, 3723);
			add_location(p2, file$1, 142, 95, 3720);
			add_location(p3, file$1, 144, 4, 3798);
		},
		m: function mount(target, anchor) {
			mount_component(media, target, anchor);
			insert_dev(target, t0, anchor);
...
function create_default_slot_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "container py-3");
			add_location(div, file$1, 154, 0, 3961);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(media0, div, null);
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "container py-3");
			add_location(div, file$1, 171, 0, 4418);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(media0, div, null);
