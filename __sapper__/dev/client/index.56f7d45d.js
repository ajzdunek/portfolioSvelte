import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.2b585221.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "overlay svelte-1b1w9e6");
			add_location(div0, file, 84, 6, 1139);
			if (source.src !== (source_src_value = "coding-video.mp4")) attr_dev(source, "src", source_src_value);
			attr_dev(source, "type", "video/mp4");
			add_location(source, file, 87, 8, 1263);
			video.playsInline = "playsinline";
			video.autoplay = "autoplay";
			video.muted = "muted";
			video.loop = "loop";
			attr_dev(video, "class", "svelte-1b1w9e6");
			add_location(video, file, 86, 6, 1174);
			attr_dev(h10, "class", "display-3 az svelte-1b1w9e6");
			add_location(h10, file, 94, 12, 1524);
			attr_dev(h11, "class", "display-6 az svelte-1b1w9e6");
			add_location(h11, file, 95, 12, 1580);
			attr_dev(p, "class", "py-5 about-me svelte-1b1w9e6");
			add_location(p, file, 96, 12, 1641);
			attr_dev(div1, "class", "whoami-mobile");
			add_location(div1, file, 93, 10, 1484);
			add_location(footer, file, 102, 14, 2133);
			attr_dev(i0, "class", "fab fa-linkedin-in fa-2x mr-2");
			add_location(i0, file, 105, 103, 2336);
			attr_dev(a0, "href", "https://www.linkedin.com/in/azdunek/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "rel", "noopener noreferrer");
			add_location(a0, file, 105, 14, 2247);
			attr_dev(i1, "class", "fab fa-github index-fa-github fa-2x ml-3 svelte-1b1w9e6");
			add_location(i1, file, 106, 94, 2480);
			attr_dev(a1, "href", "https://github.com/ajzdunek");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "rel", "noopener noreferrer");
			add_location(a1, file, 106, 14, 2400);
			attr_dev(i2, "class", "fab fa-stack-overflow fa-2x ml-3");
			add_location(i2, file, 107, 114, 2655);
			attr_dev(a2, "href", "https://stackoverflow.com/users/9090178/azdunek");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "rel", "noopener noreferrer");
			add_location(a2, file, 107, 14, 2555);
			attr_dev(div2, "class", "container py-3 text-center svelte-1b1w9e6");
			add_location(div2, file, 104, 14, 2192);
			attr_dev(div3, "class", "az-sd svelte-1b1w9e6");
			add_location(div3, file, 101, 12, 2099);
			attr_dev(div4, "class", "w-100 text-white");
			add_location(div4, file, 92, 10, 1443);
			attr_dev(div5, "class", "d-flex h-100 text-center align-items-center");
			add_location(div5, file, 91, 8, 1375);
			attr_dev(div6, "class", "container h-100 svelte-1b1w9e6");
			add_location(div6, file, 90, 6, 1337);
			attr_dev(header, "class", "svelte-1b1w9e6");
			add_location(header, file, 83, 4, 1124);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
