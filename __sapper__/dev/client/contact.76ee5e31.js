import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, B as create_slot, p as assign, o as compute_rest_props, v as validate_slots, r as exclude_internal_props, u as classnames, e as element, f as claim_element, g as children, b as detach_dev, C as set_attributes, k as add_location, l as insert_dev, J as listen_dev, D as update_slot, E as get_spread_update, A as transition_in, y as transition_out, K as bubble, w as empty, x as group_outros, z as check_outros, L as isObject, M as getColumnSizeClass, N as globals, O as to_number, P as select_value, Q as add_render_callback, R as select_options, T as select_option, U as run_all, V as set_input_value, n as noop, F as create_component, G as claim_component, H as mount_component, I as destroy_component, a as space, c as claim_space, t as text, h as claim_text, m as append_dev } from './client.6a6c18da.js';
...
function create_default_slot_11(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(option0, file$4, 94, 6, 2332);
			option1.__value = "2";
			option1.value = option1.__value;
			add_location(option1, file$4, 95, 6, 2357);
			option2.__value = "3";
			option2.value = option2.__value;
			add_location(option2, file$4, 96, 6, 2382);
			option3.__value = "4";
			option3.value = option3.__value;
			add_location(option3, file$4, 97, 6, 2407);
			option4.__value = "5";
			option4.value = option4.__value;
			add_location(option4, file$4, 98, 6, 2432);
		},
		m: function mount(target, anchor) {
...
function instance$4($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ Form, FormGroup, FormText: FormGroup, Label, Input });
	return [];
}
