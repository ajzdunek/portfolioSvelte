...
function create_default_slot_5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p1, file$1, 181, 2, 4204);
		},
		m: function mount(target, anchor) {
			mount_component(media, target, anchor);
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "container py-3");
			add_location(div, file$1, 193, 0, 4418);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(media0, div, null);
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(hr7, file$1, 188, 0, 4402);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
