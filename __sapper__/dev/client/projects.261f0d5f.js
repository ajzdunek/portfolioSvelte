...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(hr5, file$1, 168, 0, 4451);
			attr_dev(hr6, "class", "style-one svelte-907jz6");
			add_location(hr6, file$1, 187, 0, 4910);
			attr_dev(hr7, "class", "style-one svelte-907jz6");
			add_location(hr7, file$1, 204, 0, 5382);
