import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.fad2c78e.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "overlay svelte-trltnq");
			add_location(div0, file, 95, 6, 1267);
			if (source.src !== (source_src_value = "coding-video.mp4")) attr_dev(source, "src", source_src_value);
			attr_dev(source, "type", "video/mp4");
			add_location(source, file, 98, 8, 1391);
			video.playsInline = "playsinline";
			video.autoplay = "autoplay";
			video.muted = "muted";
			video.loop = "loop";
			attr_dev(video, "class", "svelte-trltnq");
			add_location(video, file, 97, 6, 1302);
			attr_dev(h10, "class", "display-3 az svelte-trltnq");
			add_location(h10, file, 105, 12, 1652);
			attr_dev(h11, "class", "display-6 az svelte-trltnq");
			add_location(h11, file, 106, 12, 1708);
			attr_dev(p, "class", "py-5 about-me svelte-trltnq");
			add_location(p, file, 107, 12, 1769);
			attr_dev(div1, "class", "whoami-mobile svelte-trltnq");
			add_location(div1, file, 104, 10, 1612);
			add_location(footer, file, 113, 14, 2261);
			attr_dev(i0, "class", "fab fa-linkedin-in fa-2x mr-2");
			add_location(i0, file, 116, 103, 2464);
			attr_dev(a0, "href", "https://www.linkedin.com/in/azdunek/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "rel", "noopener noreferrer");
			add_location(a0, file, 116, 14, 2375);
			attr_dev(i1, "class", "fab fa-github index-fa-github fa-2x ml-3 svelte-trltnq");
			add_location(i1, file, 117, 94, 2608);
			attr_dev(a1, "href", "https://github.com/ajzdunek");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "rel", "noopener noreferrer");
			add_location(a1, file, 117, 14, 2528);
			attr_dev(i2, "class", "fab fa-stack-overflow fa-2x ml-3");
			add_location(i2, file, 118, 114, 2783);
			attr_dev(a2, "href", "https://stackoverflow.com/users/9090178/azdunek");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "rel", "noopener noreferrer");
			add_location(a2, file, 118, 14, 2683);
			attr_dev(div2, "class", "container py-3 text-center svelte-trltnq");
			add_location(div2, file, 115, 14, 2320);
			attr_dev(div3, "class", "az-sd svelte-trltnq");
			add_location(div3, file, 112, 12, 2227);
			attr_dev(div4, "class", "w-100 text-white");
			add_location(div4, file, 103, 10, 1571);
			attr_dev(div5, "class", "d-flex h-100 text-center align-items-center");
			add_location(div5, file, 102, 8, 1503);
			attr_dev(div6, "class", "container h-100 svelte-trltnq");
			add_location(div6, file, 101, 6, 1465);
			attr_dev(header, "class", "svelte-trltnq");
			add_location(header, file, 94, 4, 1252);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
