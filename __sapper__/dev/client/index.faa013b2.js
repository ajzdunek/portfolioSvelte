import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.d4d9dca1.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "overlay svelte-17jb8v2");
			add_location(div0, file, 113, 6, 1674);
			if (source.src !== (source_src_value = "coding-video.mp4")) attr_dev(source, "src", source_src_value);
			attr_dev(source, "type", "video/mp4");
			add_location(source, file, 116, 8, 1798);
			video.playsInline = "playsinline";
			video.autoplay = "autoplay";
			video.muted = "muted";
			video.loop = "loop";
			attr_dev(video, "class", "svelte-17jb8v2");
			add_location(video, file, 115, 6, 1709);
			attr_dev(h10, "class", "display-3 me svelte-17jb8v2");
			add_location(h10, file, 123, 12, 2059);
			attr_dev(h11, "class", "display-6 occupation svelte-17jb8v2");
			add_location(h11, file, 124, 12, 2115);
			attr_dev(p, "class", "py-5 about-me svelte-17jb8v2");
			add_location(p, file, 125, 12, 2184);
			attr_dev(div1, "class", "whoami-mobile");
			add_location(div1, file, 122, 10, 2019);
			add_location(footer, file, 131, 14, 2676);
			attr_dev(i0, "class", "fab fa-linkedin-in fa-2x mr-2");
			add_location(i0, file, 134, 103, 2879);
			attr_dev(a0, "href", "https://www.linkedin.com/in/azdunek/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "rel", "noopener noreferrer");
			add_location(a0, file, 134, 14, 2790);
			attr_dev(i1, "class", "fab fa-github index-fa-github fa-2x ml-3 svelte-17jb8v2");
			add_location(i1, file, 135, 94, 3023);
			attr_dev(a1, "href", "https://github.com/ajzdunek");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "rel", "noopener noreferrer");
			add_location(a1, file, 135, 14, 2943);
			attr_dev(i2, "class", "fab fa-stack-overflow fa-2x ml-3");
			add_location(i2, file, 136, 114, 3198);
			attr_dev(a2, "href", "https://stackoverflow.com/users/9090178/azdunek");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "rel", "noopener noreferrer");
			add_location(a2, file, 136, 14, 3098);
			attr_dev(div2, "class", "container py-3 text-center svelte-17jb8v2");
			add_location(div2, file, 133, 14, 2735);
			attr_dev(div3, "class", "az-sd svelte-17jb8v2");
			add_location(div3, file, 130, 12, 2642);
			attr_dev(div4, "class", "w-100 text-white");
			add_location(div4, file, 121, 10, 1978);
			attr_dev(div5, "class", "d-flex h-100 text-center align-items-center");
			add_location(div5, file, 120, 8, 1910);
			attr_dev(div6, "class", "container h-100 svelte-17jb8v2");
			add_location(div6, file, 119, 6, 1872);
			attr_dev(header, "class", "svelte-17jb8v2");
			add_location(header, file, 112, 4, 1659);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
