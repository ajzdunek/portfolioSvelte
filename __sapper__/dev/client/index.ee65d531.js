import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.4324c6bf.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "overlay svelte-fl441p");
			add_location(div0, file, 97, 6, 1321);
			if (source.src !== (source_src_value = "coding-video.mp4")) attr_dev(source, "src", source_src_value);
			attr_dev(source, "type", "video/mp4");
			add_location(source, file, 100, 8, 1445);
			video.playsInline = "playsinline";
			video.autoplay = "autoplay";
			video.muted = "muted";
			video.loop = "loop";
			attr_dev(video, "class", "svelte-fl441p");
			add_location(video, file, 99, 6, 1356);
			attr_dev(h10, "class", "display-3 az svelte-fl441p");
			add_location(h10, file, 106, 12, 1668);
			attr_dev(h11, "class", "display-6 az svelte-fl441p");
			add_location(h11, file, 107, 12, 1724);
			attr_dev(p, "class", "py-5 about-me svelte-fl441p");
			add_location(p, file, 108, 12, 1785);
			add_location(footer, file, 114, 14, 2259);
			attr_dev(i0, "class", "fab fa-linkedin-in fa-2x mr-2");
			add_location(i0, file, 117, 103, 2462);
			attr_dev(a0, "href", "https://www.linkedin.com/in/azdunek/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "rel", "noopener noreferrer");
			add_location(a0, file, 117, 14, 2373);
			attr_dev(i1, "class", "fab fa-github index-fa-github fa-2x ml-3 svelte-fl441p");
			add_location(i1, file, 118, 94, 2606);
			attr_dev(a1, "href", "https://github.com/ajzdunek");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "rel", "noopener noreferrer");
			add_location(a1, file, 118, 14, 2526);
			attr_dev(i2, "class", "fab fa-stack-overflow fa-2x ml-3");
			add_location(i2, file, 119, 114, 2781);
			attr_dev(a2, "href", "https://stackoverflow.com/users/9090178/azdunek");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "rel", "noopener noreferrer");
			add_location(a2, file, 119, 14, 2681);
			attr_dev(div1, "class", "container py-3 text-center svelte-fl441p");
			add_location(div1, file, 116, 14, 2318);
			attr_dev(div2, "class", "az-sd svelte-fl441p");
			add_location(div2, file, 113, 12, 2225);
			attr_dev(div3, "class", "w-100 text-white");
			add_location(div3, file, 105, 10, 1625);
			attr_dev(div4, "class", "d-flex h-100 text-center align-items-center");
			add_location(div4, file, 104, 8, 1557);
			attr_dev(div5, "class", "container h-100 svelte-fl441p");
			add_location(div5, file, 103, 6, 1519);
			attr_dev(header, "class", "svelte-fl441p");
			add_location(header, file, 96, 4, 1306);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
