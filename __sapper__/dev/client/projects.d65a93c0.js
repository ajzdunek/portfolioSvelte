...
function create_default_slot_5(ctx) {
	...
	const block = {
		c: function create() {
			create_component(media.$$.fragment);
			t0 = text("\n    A fully functional independant music blog built with Jekyll, a blog-aware, static site generator written in Ruby. One of the features I'm proud of in this project so far was the ability to add search functionality so you can search for yours or your friends band. \n    It's not the most exciting feature but from a developers perspective it was a good challenge for me to take on.\n\n  ");
			p = element("p");
		...
		h: function hydrate() {
			add_location(p, file$1, 181, 2, 4197);
		},
		m: function mount(target, anchor) {
			mount_component(media, target, anchor);
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "container py-3");
			add_location(div, file$1, 193, 0, 4411);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(media0, div, null);
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(hr7, file$1, 188, 0, 4395);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
