...
function create_default_slot_13(ctx) {
	...
	const block = {
		c: function create() {
			create_component(media.$$.fragment);
			t0 = text("\n    Creating a simple static band website using.  I am no longer the bass player for this project but still maintain the website for the band.\n\n    ");
			p = element("p");
			t1 = text("Technologies used - HTML5, CSS, Bootstrap 4.1.3, JavaScript and Bandsintown events widget");
			this.h();
		},
		l: function claim(nodes) {
			claim_component(media.$$.fragment, nodes);
			...
			t1 = claim_text(p_nodes, "Technologies used - HTML5, CSS, Bootstrap 4.1.3, JavaScript and Bandsintown events widget");
			p_nodes.forEach(detach_dev);
			this.h();
		},
		h: function hydrate() {
			add_location(p, file$1, 122, 4, 2918);
		},
		m: function mount(target, anchor) {
			mount_component(media, target, anchor);
			insert_dev(target, t0, anchor);
...
function create_default_slot_9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p, file$1, 142, 2, 3606);
		},
		m: function mount(target, anchor) {
			mount_component(media, target, anchor);
			insert_dev(target, t0, anchor);
...
function create_default_slot_8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "container py-3");
			add_location(div, file$1, 131, 0, 3078);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(media0, div, null);
...
function create_default_slot_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "container py-3");
			add_location(div, file$1, 154, 0, 3838);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(media0, div, null);
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "container py-3");
			add_location(div, file$1, 171, 0, 4295);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(media0, div, null);
