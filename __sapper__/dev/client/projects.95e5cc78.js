...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t3 = claim_text(em_nodes, "Technologies used - ");
		...
		h: function hydrate() {
			...
			add_location(em, file$1, 122, 7, 2928);
...
function create_default_slot_9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file$1, 140, 4, 3362);
			add_location(p1, file$1, 142, 4, 3631);
		},
		m: function mount(target, anchor) {
			mount_component(media, target, anchor);
			insert_dev(target, t0, anchor);
...
function create_default_slot_8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "container py-3");
			add_location(div, file$1, 131, 0, 3094);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(media0, div, null);
...
function create_default_slot_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "container py-3");
			add_location(div, file$1, 154, 0, 3865);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(media0, div, null);
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "container py-3");
			add_location(div, file$1, 171, 0, 4322);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(media0, div, null);
