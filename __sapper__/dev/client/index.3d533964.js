...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 50, 6, 773);
			add_location(li, file, 50, 2, 769);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			document.title = "Blog";
			attr_dev(h1, "class", "svelte-1qn9y9m");
			add_location(h1, file, 42, 0, 504);
			attr_dev(ul, "class", "svelte-1qn9y9m");
			add_location(ul, file, 44, 0, 523);
			attr_dev(div, "class", "container");
			add_location(div, file, 40, 0, 479);
		},
		m: function mount(target, anchor) {
