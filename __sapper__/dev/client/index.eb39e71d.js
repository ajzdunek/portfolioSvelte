...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 43, 6, 737);
			add_location(li, file, 43, 2, 733);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 35, 0, 468);
			attr_dev(ul, "class", "svelte-7jf810");
			add_location(ul, file, 37, 0, 487);
			attr_dev(div, "class", "container");
			add_location(div, file, 33, 0, 443);
		},
		m: function mount(target, anchor) {
