...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			document.title = "Blog";
			attr_dev(h1, "class", "svelte-zm4lt");
			add_location(h1, file, 38, 0, 448);
			attr_dev(ul, "class", "svelte-zm4lt");
