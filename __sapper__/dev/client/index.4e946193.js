...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			document.title = "Blog";
			attr_dev(h1, "class", "svelte-wa7ejs");
			add_location(h1, file, 35, 0, 420);
			attr_dev(ul, "class", "svelte-wa7ejs");
