...
${($$result.head += `${($$result.title = `<title>Andrew Zdunek</title>`, "")}`, "")}
    ...
    <header class="${"svelte-17jb8v2"}"><div class="${"overlay svelte-17jb8v2"}"></div>

      <video playsinline="${"playsinline"}" autoplay="${"autoplay"}" muted="${"muted"}" loop="${"loop"}" class="${"svelte-17jb8v2"}"><source src="${"coding-video.mp4"}" type="${"video/mp4"}"></video>
	  
      <div class="${"container h-100 svelte-17jb8v2"}"><div class="${"d-flex h-100 text-center align-items-center"}"><div class="${"w-100 text-white"}"><div class="${"whoami-mobile"}"><h1 class="${"display-3 me svelte-17jb8v2"}">Andrew Zdunek</h1>
            <h1 class="${"display-6 occupation svelte-17jb8v2"}">Software Developer</h1>
            <p class="${"py-5 about-me svelte-17jb8v2"}">A software developer turned technical recruiter who&#39;s pivoting back into the software development space.
              From the time I produced my first &quot;Hello World&quot; to creating band/artist pages with HTML, CSS and later diving into programming languages 
            ...
            <div class="${"az-sd svelte-17jb8v2"}"><footer>AZ | Software Developement</footer>

              <div class="${"container py-3 text-center svelte-17jb8v2"}"><a href="${"https://www.linkedin.com/in/azdunek/"}" target="${"_blank"}" rel="${"noopener noreferrer"}"><i class="${"fab fa-linkedin-in fa-2x mr-2"}"></i></a>
              <a href="${"https://github.com/ajzdunek"}" target="${"_blank"}" rel="${"noopener noreferrer"}"><i class="${"fab fa-github index-fa-github fa-2x ml-3 svelte-17jb8v2"}"></i></a>
