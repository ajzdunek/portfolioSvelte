...
${($$result.head += `${($$result.title = `<title>Andrew Zdunek</title>`, "")}`, "")}
    ...
    <header class="${"svelte-w0k419"}"><div class="${"overlay svelte-w0k419"}"></div>

      <video playsinline="${"playsinline"}" autoplay="${"autoplay"}" muted="${"muted"}" loop="${"loop"}" class="${"svelte-w0k419"}"><source src="${"coding-video.mp4"}" type="${"video/mp4"}"></video>
	  
      <div class="${"container h-100 svelte-w0k419"}"><div class="${"d-flex h-100 text-center align-items-center"}"><div class="${"w-100 text-white"}"><div class="${"whoami-mobile svelte-w0k419"}"><h1 class="${"display-3 me svelte-w0k419"}">Andrew Zdunek</h1>
            <h1 class="${"display-6 occupation svelte-w0k419"}">Software Developer</h1>
            <p class="${"py-5 about-me svelte-w0k419"}">A software developer turned technical recruiter who&#39;s pivoting back into the software development space.
              From the time I produced my first &quot;Hello World&quot; to creating band/artist pages with HTML, CSS and later diving into programming languages 
            ...
            <div class="${"az-sd svelte-w0k419"}"><footer>AZ | Software Developement</footer>

              <div class="${"container py-3 text-center svelte-w0k419"}"><a href="${"https://www.linkedin.com/in/azdunek/"}" target="${"_blank"}" rel="${"noopener noreferrer"}"><i class="${"fab fa-linkedin-in fa-2x mr-2"}"></i></a>
              <a href="${"https://github.com/ajzdunek"}" target="${"_blank"}" rel="${"noopener noreferrer"}"><i class="${"fab fa-github index-fa-github fa-2x ml-3 svelte-w0k419"}"></i></a>
